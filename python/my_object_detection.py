...
from od_functions import getOutputsNames, drawPred, postprocess
...
modelWeights = "AN_yolov3_2000.weights";
...
image_dir='/Users/erikhedlin/Desktop/ML/Site 98'
...
for f in sorted(os.listdir(image_dir)): 
    ...
    postprocess(img, outs,classes,confThreshold,nmsThreshold,fileID)
